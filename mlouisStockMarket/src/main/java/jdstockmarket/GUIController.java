...
//
//        fetchButton.addActionListener(e -> fetchStockInfo("dummy period"));
...
//        gbc.gridy++;
//        stockSymbolField = createStyledTextField(10);
//        stockSymbolField.addActionListener(e -> fetchStockInfo("dummy period"));
...
//     */
//    private void fetchStockInfo(String period) {
...
//        try {
//            
//        	JSONObject stockJSON = jsonHandler.fetchStockData(stockAPI, stockSymbol, period);
//            String displayText = jsonHandler.displayStockInfo(stockJSON, stockSymbol, period);
